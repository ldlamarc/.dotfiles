...
alias gf="git fetch -f --tags"
alias gpro="git pull --rebase origin"
alias gri="git rebase -i"
alias gmb="git branch --merged| egrep -v \"(^\*|master|main|develop)\""
alias gmbr="git branch --merged| egrep -v \"(^\*|master|main|develop)\" | xargs git branch -d"
alias be="bundle exec"
alias brails="be rails"
alias railsd="WEB_CONCURRENCY=1 be rails"
alias dc="docker-compose"
alias dcup="docker-compose up -d"
alias dcdown="docker-compose down"
alias dce="docker-compose exec"
alias gclf="git checkout @{-2}"
alias rubocoptodo="bundle exec rubocop --config .rubocop.ci.yml --auto-gen-config --auto-gen-only-exclude --no-exclude-limit"
...
# Vi mode for command line instead of Emaclike bindings
bindkey -v
